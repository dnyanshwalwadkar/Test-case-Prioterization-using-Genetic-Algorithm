...
def parse_cl_args():
    ...
    parser.add_argument("-nsols", type=int, default=1, dest='nsols', help='number of solutions per generation, default: 50')
...
def main():
    ...
    opt_alg = WOA.WhaleOptimization(test_case_fault_matrix,  nsols, b, a, maximize)
    #print("opt_alg-------------")
    #print(opt_alg)
    #solutions = opt_alg.get_solutions()
    #colors = [[1.0, 1.0, 1.0] for _ in range(nsols)]

    # #a_scatter = animat.AnimateScatter(constraints[0][0],
    #                            constraints[0][1],
    #                            constraints[1][0],
    #                            constraints[1][1],
