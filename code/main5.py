...
def main():
    ...
    data_set_name = 'bigfaultmatrix2.txt'
    ...
    print("------------- New Mutation rate -------------")
    data_set_name = 'bigfaultmatrix3.txt'
    ...
    ax.set_xticklabels([ 'File 1','File 2','File 3','File 4'])
    ...
    # Save the figure
    graph_path = os.path.join(pwd, 'graph4.pdf')
